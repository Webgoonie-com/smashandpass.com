    ...
    return (
        <>
            <div
                ...
                inset-0 z-50 outline-none focus:outline-none bg-neutral-950/90
                "
            >
                <div
                    className="
                        relative w-full md:w-4/6 
                        lg:w-3/6 xl:w-2/5 my-6 mx-auto 
                    ...
                    `}>
                        <div className="
                            translate h-full lg:h-auto md:h-auto border-0 
                        ...
                        ">
                            ...
                            <div
                                ...
                                ">
                                    ...
                                    <div id="modalHeaderTitle" className="text-lg font-semibold">
                                        {title}
                                    </div>
                            </div>
                            <div
