...
$find_user_query = "SELECT * FROM `smashan_smashandpass`.`user_profile_photoblobs`, `smashan_smashandpass`.`users` WHERE `profile_photoblob_user_id` = `user_id`  AND `profile_photoblob_id` = '$pic_id'  ORDER BY `profile_photoblob_id` DESC LIMIT 1";
...
$userblob_users_id = $row_ofuser['profile_photoblob_user_id'];
$picthread_userblob_id = $row_ofuser['profile_photoblob_id'];
...
$converted_time_1 = date("M d Y h:i a D", strtotime($row_ofuser['profile_photoblob_created_at']));
...
<div class="container">
	<div class="row justify-content-md-center">
                ...
                <div class="col-10-md" align="center" style="margin-left:100px; margin-right:100px;">
                    ...
                    <div class="col-sm-12" align="center" style="background-color:#000; padding:5px;">

                        <div class="wrap-pic" align="center">
                        <?php // echo $userblob.base64_encode($row_ofuser['userblob_image'] ); ?>

                        <img id="big_pication" src="<?php echo $row_ofuser['profile_photoblob_filepath']; ?>" class="img-responsive" alt="">
                        </div>
