...
$query_plyrassetscount_sql = "SELECT 
	`users`.`user_id`,`users`.`user_nickname`, `users`.`user_profile_blob`, `users`.`user_networth_ply`,  
	SUM(`users`.`user_networth_ply`) as CountMyOwnNetworth, 
	count(`users`.`user_id`) as CountMyPlyrassets 
FROM 
...
$CountMyOwnNetworth = $row_plyrassets_counts['CountMyOwnNetworth']; 
...
<?php include_once("analyticstracking_private.php") ?>
    ...
    <div class="container hidden-xs">
    	<div class="header-title">
        	<div class="pull-left">
        		<h2><a href="#"><span class="text-primary">Ass</span>ets</a></h2>
                <p>All the assets you own</p>
            </div>
        </div>
    </div>
    <!-- ==========================
    ...
    <div class="container">
        <section class="content-wrapper">
        	<div class="box">
                ...
                <!-- ERROR - START -->
                <div class="error">
                	<h2>Asset Page yet not complete</h2>
                	<p>Here you find all the assets you own lest below</p>
                	<a href="news" class="btn btn-primary btn-lg">Back to Homepage</a>
                </div>
                <!-- ERROR - END -->
