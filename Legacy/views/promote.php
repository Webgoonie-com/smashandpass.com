...
$find_members_following_query = "SELECT * FROM `smashan_smashandpass`.`user_following` 
WHERE 
  ...
  <?php } while ($row_ofuser_pic = mysqli_fetch_array($result_ofuser_pic)); ?>
                ...
                =========================== -->
                            <div class="box colored config">
                                <p>Here you can gain more buying power by purchasing a credits package. <a href="/buycredits" class="btn btn-simple">Buy Gold</a></p>
                            </div>
                            ...
                            <article class="post">
                                    ...
                                    <div class="post-body">
                                        <h2><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Earn More Credits Today</font></font></h2>
