...
if(isset($_POST['user_id'], $_POST['usr_cookie'], $_POST['member_id'])){
	...
	$check_friendship_request_query_sql = "SELECT * FROM `smashan_smashandpass`.`user_friends` WHERE `friend_userid` = '$member_id' AND `friend_memberid` = '$user_id' LIMIT 1";
	...
	$insert_friendship_req_sql = "
		INSERT INTO `smashan_smashandpass`.`user_friends` SET
						`friend_userid` = '$member_id',
						`friend_memberid` = '$user_id'
	";
