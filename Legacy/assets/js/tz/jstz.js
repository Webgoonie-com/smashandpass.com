...
var jstz = function () {
  var HEMISPHERE_SOUTH = 's',
	...
	function get_january_offset() {
		return get_date_offset(new Date(2019, 0, 1, 0, 0, 0, 0));
	};

	function get_june_offset() {
		return get_date_offset(new Date(2019, 5, 1, 0, 0, 0, 0));
	};
...
jstz.olson = {
	 ...
	 * Changed from 2011 to 2019
	 * Changed from 2010 to 2020
	 * Need to reEdit to reflect current year time zone Difference if this object is going to be used.
	 * 06-05-2019 Goonie
	 */
	dst_start_dates : {
		'America/Denver' : new Date(2019, 2, 13, 3, 0, 0, 0),
		'America/Mazatlan' : new Date(2019, 3, 3, 3, 0, 0, 0),
		'America/Chicago' : new Date(2019, 2, 13, 3, 0, 0, 0),
		'America/Mexico_City' : new Date(2019, 3, 3, 3, 0, 0, 0),
		'Atlantic/Stanley' : new Date(2019, 8, 4, 7, 0, 0, 0),
		'America/Asuncion' : new Date(2019, 9, 2, 3, 0, 0, 0),
		'America/Santiago' : new Date(2019, 9, 9, 3, 0, 0, 0),
		'America/Campo_Grande' : new Date(2019, 9, 16, 5, 0, 0, 0),
		'America/Montevideo' : new Date(2019, 9, 2, 3, 0, 0, 0),
		'America/Sao_Paulo' : new Date(2019, 9, 16, 5, 0, 0, 0),
		'America/Los_Angeles' : new Date(2019, 2, 13, 8, 0, 0, 0),
		'America/Santa_Isabel' : new Date(2019, 3, 5, 8, 0, 0, 0),
		'Asia/Gaza' : new Date(2019, 2, 26, 23, 0, 0, 0),
		'Asia/Beirut' : new Date(2019, 2, 27, 1, 0, 0, 0),
		'Europe/Minsk' : new Date(2019, 2, 27, 3, 0, 0, 0),
		'Europe/Helsinki' : new Date(2019, 2, 27, 4, 0, 0, 0),
		'Europe/Istanbul' : new Date(2019, 2, 28, 5, 0, 0, 0),
		'Asia/Damascus' : new Date(2019, 3, 1, 2, 0, 0, 0),
		'Asia/Jerusalem' : new Date(2019, 3, 1, 6, 0, 0, 0),
		'Africa/Cairo' : new Date(2020, 3, 30, 4, 0, 0, 0),
		'Asia/Yerevan' : new Date(2019, 2, 27, 4, 0, 0, 0),
		'Asia/Baku'    : new Date(2019, 2, 27, 8, 0, 0, 0),
		'Pacific/Auckland' : new Date(2019, 8, 26, 7, 0, 0, 0),
		'Pacific/Fiji' : new Date(2020, 11, 29, 23, 0, 0, 0),
		'America/Halifax' : new Date(2019, 2, 13, 6, 0, 0, 0),
		'America/Goose_Bay' : new Date(2019, 2, 13, 2, 1, 0, 0),
		'America/Miquelon' : new Date(2019, 2, 13, 5, 0, 0, 0),
		'America/Godthab' : new Date(2019, 2, 27, 1, 0, 0, 0)
	}
};
