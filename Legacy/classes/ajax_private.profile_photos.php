...
?>
                    ...
                    <?php do { ?>
                                                    ...
                                                    <div id="<?php echo $row_ofuser['userblob_id']; ?>" class="col-md-4 col-xs-6 profile_pic_op">
                                                        <a rel="<?php echo $row_ofuser['userblob_id']; ?>" title="<?php echo $row_ofuser['userblob_image_created_at']; ?>"><img src="<?php echo 'data:image/jpeg;base64,'.base64_encode($row_ofuser['userblob_image'] ); ?>" class="img-responsive" alt=""></a>
                                                    </div>
